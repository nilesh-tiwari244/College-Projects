...
%  figure
%  func_plot_ber_vs_snr(6.6753e-06,90,'--ob');
%  hold on
%  func_7_analytical_ber_snr_plot(6.64e-06,90,113,'-y')
%  hold on
%  func_plot_ber_vs_snr(7.585e-06,90,'--Xr');
%  hold on
%  func_7_analytical_ber_snr_plot(7.55e-06,90,113,'-g')
%  legend('one photo-resistor, Simulation','one photo-resistor, Analytical','Two photo-resistors, Simulation','Two photo-resistors, Analytical');
